    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white w-full h-full flex flex-col overflow-hidden">
        ...
        <div className="overflow-y-auto overflow-x-hidden flex-1 p-6">
          <form id="profileForm" onSubmit={handleSubmit} className="space-y-12 max-w-[1000px] mx-auto">
            <div className="space-y-6">
              {/* Avatar */}
              <h2 className="text-lg font-medium text-black mb-4">Avatar</h2>
              ...
              {/* Basic Info */}
              <h2 className="text-lg font-medium text-black mb-4">Basic Info</h2>
              <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-500 mb-1">Alter</label>
                  <input
                    type="number"
                    value={formData.age}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-500 mb-1">Geschlecht</label>
                  <select
              ...
              {/* Location & Bio */}
              <h2 className="text-lg font-medium text-black mb-4">Wohnort / Bio</h2>
              <div>
                <LocationInput
              ...
              {/* Languages & Tags */}
              <h2 className="text-lg font-medium text-black mb-4">Sprachen</h2>
              <LanguageSelect
                selected={formData.languages}
                onChange={(languages) => setFormData({ ...formData, languages })}
              />

              <h2 className="text-lg font-medium text-black mb-4">Status-Tags</h2>
              <IntentTagSelect
            ...
            <div className="space-y-4">
              <h2 className="text-lg font-medium text-black mb-6">Kontaktdaten</h2>
              <div>
            ...
            {/* Skills */}
            <div>
              <h2 className="text-lg font-medium text-black mb-6">Skills</h2>
              <SkillsEditor
                skills={skills} 
                onChange={setSkills} 
              />
            ...
            {/* Add padding at the bottom to ensure content isn't hidden behind the fixed button bar */}
            {/* <div className="h-8"></div>*/}
          </form>
        </div>
        
        {/* Fixed button bar at the bottom */}
        <div className="border-t bg-white p-2 flex justify-around gap-4 sticky bottom-0 w-full">
          <button
            type="button"
            onClick={onClose}
